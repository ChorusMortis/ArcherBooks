...
class FavoritesFavsAdapter(private val data: ArrayList<BookModel>): RecyclerView.Adapter<FavoritesFavsViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesFavsViewHolder {
        ...
        val itemFavsViewBinding = ItemFavoritesCardLightBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private fun addListenerCard(holder : FavoritesFavsViewHolder, itemFavsViewBinding: ItemFavoritesCardLightBinding) {
