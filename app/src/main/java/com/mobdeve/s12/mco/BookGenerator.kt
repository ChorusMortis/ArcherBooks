...
class BookGenerator {
    companion object {
        fun generateSampleBooks() : ArrayList<BookModel> {
            ...
            data.add(BookModel("/works/OL24216892W", "Scarlet Witch", arrayListOf("James Robinson","Vanesa R. Del Rey","Marco Rudy","Steve Dillon","Chris Visions"), arrayListOf("Literature"), "Panini Books", R.drawable.scarlet_witch,
                "12F 15D", 2021))
            ...
            data.add(BookModel("/works/OL8115854W", "Il mio nome è Stilton, Geronimo Stilton", arrayListOf("Elisabetta Dami"), arrayListOf("Juvenile fiction","Mice","Journalists","Fiction","Humorous stories","Souris","Romans, nouvelles, etc. pour la jeunesse","Journalistes","Action & Adventure","Animals"), "Turtleback Books Distributed by Demco Media", R.drawable.geronimo_stilton,
                "8F 31W", 1999))
            data.add(BookModel("/works/OL260413W", "The Tower of Babel", arrayListOf("Morris West"), arrayListOf("Middle east, fiction","Fiction, war & military","Fiction, political","Israel-arab war, 1967, fiction"), "Hodder & Stoughton General Division", R.drawable.tower_of_babel,
                "11F 43K", 1974))
            data.add(BookModel("/works/OL412310W", "Snow White", arrayListOf("Brothers Grimm"), arrayListOf(), "Amer School Pub", R.drawable.snow_white,
                "10F 93W", 1979))
            data.add(BookModel("/works/OL18417W", "The Wonderful Wizard of Oz", arrayListOf("L. Frank Baum"), arrayListOf("Witches","Toy and movable books","Spanish language materials","Fiction","Wizards","Juvenile literature","Wizards in fiction","Children's stories, Russian","Specimens","Imaginary voyages in fiction"), "Henry Holt", R.drawable.wizard_of_oz,
                "8F 95G", 1900))
            data.add(BookModel("/works/OL45429W", "Little Red Riding Hood", arrayListOf("Charles Perrault,Brothers Grimm"), arrayListOf("Tales","Fairy tales","Juvenile literature","Folklore","Little Red Riding Hood (Tale)","Pictorial works","Germany","Fairy Tales & Folklore - Single Title","Children's Books/Ages 4-8 Fiction","Children: Grades 2-3"), "William Morrow & Company", R.drawable.little_red_riding_hood,
                "13F 70E", 1945))
            data.add(BookModel("/works/OL5735363W", "The Hunger Games", arrayListOf("Suzanne Collins"), arrayListOf("severe poverty","starvation","oppression","effects of war","self-sacrifice","Science fiction","Apocalyptic fiction","Dystopian fiction","Fiction","Juvenile works"), "Klett Sprachen GmbH", R.drawable.hunger_games,
                "13F 33E", 2008))
            data.add(BookModel("/works/OL82563W", "Harry Potter and the Philosopher's Stone", arrayListOf("J. K. Rowling"), arrayListOf("Ghosts","Monsters","Vampires","Witches","Challenges and Overcoming Obstacles","Magic and Supernatural","Cleverness","School Life","school stories","Wizards"), "Bloomsbury USA Children's Books", R.drawable.harry_potter,
                "9F 94V", 1997))
